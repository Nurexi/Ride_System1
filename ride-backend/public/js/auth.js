...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function switchForm(formName) {
        ...
        switch (formName) {
            ...
            case 'signup':
                ...
                break;
            case 'forgot':
                formToShow = forgotForm;
                currentForm = 'forgot';
                mobileToggle.innerHTML = '<i class="fas fa-exchange-alt"></i><span>Back to Login</span>';
                break;
        }
    ...
    async function handleSignup() {
        ...
        const licenseNumber = document.getElementById('signupLicense').value;
    ...
    function simulatePasswordReset() {
        ...
        // Show loading state
        const submitBtn = forgotFormElement.querySelector('button[type="submit"]');
        const originalText = submitBtn.innerHTML;
